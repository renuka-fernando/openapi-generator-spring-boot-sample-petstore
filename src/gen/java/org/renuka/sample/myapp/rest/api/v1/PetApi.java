...
import org.renuka.sample.myapp.rest.api.v1.dto.ApiResponseDTO;
...
public interface PetApi {
    ...
    default ResponseEntity<PetDTO> _addPet(
        ...
        return addPet(petDTO);
    }

    // Override this method
    default  ResponseEntity<PetDTO> addPet(PetDTO petDTO) {
    ...
    default ResponseEntity<List<PetDTO>> _findPetsByStatus(
    ...
    default ResponseEntity<List<PetDTO>> _findPetsByTags(
    ...
    default ResponseEntity<PetDTO> _getPetById(
    ...
    default ResponseEntity<PetDTO> _updatePet(
        @Parameter(name = "PetDTO", description = "Pet object that needs to be added to the store", required = true) @Valid @RequestBody PetDTO petDTO
    ) {
        return updatePet(petDTO);
    }

    // Override this method
    default  ResponseEntity<PetDTO> updatePet(PetDTO petDTO) {
        AtomicInteger statusCode = new AtomicInteger(501);
            getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
    ...
    default ResponseEntity<ApiResponseDTO> _uploadFile(
    ...
    // Override this method
    default  ResponseEntity<ApiResponseDTO> uploadFile(Long petId, String additionalMetadata, MultipartFile file) {
        AtomicInteger statusCode = new AtomicInteger(501);
            getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
